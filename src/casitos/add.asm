...
Main_method: .word copy_,abort_,type_name_,out_string_,out_int_,in_string_,in_int_,initialize_IO_,add_,main_,initialize_Main_
Main: .word 12, Main_method, data_Main,Object_copy,Object_abort,Object_type_name,IO_out_string,IO_out_int,IO_in_string,IO_in_int,initialize_IO,Main_add,Main_main,initialize_Main
_vacio_ad: .word 0
_vacio: .asciiz ""
x_1_ad: .word 0
x_1: .asciiz "Hola"
