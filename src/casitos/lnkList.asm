...
List_method: .word copy_,abort_,type_name_,initialize_Object_,isNil_,head_,tail_,add_,initialize_List_
List: .word 4, List_method, data_List,Object_copy,Object_abort,Object_type_name,initialize_Object,List_isNil,List_head,List_tail,List_add,initialize_List
print_: .asciiz "print"
main_: .asciiz "main"
initialize_Main_: .asciiz "initialize_Main"
data_Main: .asciiz "Main"
Main_method: .word copy_,abort_,type_name_,out_string_,out_int_,in_string_,in_int_,initialize_IO_,print_,main_,initialize_Main_
Main: .word 8, Main_method, data_Main,Object_copy,Object_abort,Object_type_name,IO_out_string,IO_out_int,IO_in_string,IO_in_int,initialize_IO,Main_print,Main_main,initialize_Main
init_: .asciiz "init"
initialize_Cons_: .asciiz "initialize_Cons"
data_Cons: .asciiz "Cons"
Cons_method: .word copy_,abort_,type_name_,initialize_Object_,isNil_,head_,tail_,add_,initialize_List_,init_,initialize_Cons_
Cons: .word 12, Cons_method, data_Cons,Object_copy,Object_abort,Object_type_name,initialize_Object,Cons_isNil,Cons_head,Cons_tail,List_add,initialize_List,Cons_init,initialize_Cons
_vacio_ad: .word 0
_vacio: .asciiz ""
x_18_ad: .word 0
x_18: .asciiz "
