...
Main_method: .word copy_,abort_,type_name_,out_string_,out_int_,in_string_,in_int_,initialize_IO_,pal_,main_,initialize_Main_
Main: .word 8, Main_method, data_Main,Object_copy,Object_abort,Object_type_name,IO_out_string,IO_out_int,IO_in_string,IO_in_int,initialize_IO,Main_pal,Main_main,initialize_Main
_vacio_ad: .word 0
_vacio: .asciiz "vacio"
x_56_ad: .word 0
x_56: .asciiz "enter a string
"
x_63_ad: .word 0
x_63: .asciiz "that was a palindrome
"
x_67_ad: .word 0
x_67: .asciiz "that was not a palindrome
"
isvoid: .word 0
